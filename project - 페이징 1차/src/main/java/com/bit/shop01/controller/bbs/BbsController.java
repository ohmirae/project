...
public class BbsController {
	...
	// 게시글 삭제
	@RequestMapping(value = "/not_bbs_delete", method = RequestMethod.POST)
	...
	public String update(BbsVo bbsVo, Integer curPage, String bbscd, Model model) throws Exception {
		...
		return "redirect:/not_bbs_detail?bbseditno=" + bbsVo.getBbseditno() + "&bbscd=" + bbsVo.getBbscd() +   "&curPage=" + curPage;
	}
