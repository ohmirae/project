...
<form id="join" class="form-horizontal" action="/shop01/membersEdit/" method="POST" onsubmit="return check()">
  <fieldset>
    <div id="legend">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <br/>
        <br/>
          <button class="btn btn-info btn-sm active" style="width: 288px" type="button" onclick="javascript:location.href='/shop01/mypage/'" >mypage</button>
      </div>
    </div>
  </fieldset>
</form>
